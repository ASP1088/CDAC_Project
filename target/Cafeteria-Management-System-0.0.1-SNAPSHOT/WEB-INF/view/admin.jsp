...
<title>Admin Page- Cafe Dosti</title>
...
<body>
	...
	<div class="container admin mt-2">
		...
		<div class="row mt-3">
			...
			<div class="col-md-4">
				<div class="card hover" data-toggle="modal"
					data-target="#total-category-modal">
					<div class="card-body text-center">
						<div class="container">
							<img style="max-width: 120px" class="img-fluid rounded-circle"
								src="resources/images/category.png" alt="users_pic">
						</div>
						<p>click here to see the Category</p>
		...
		<div class="modal fade" id="total-category-modal" tabindex="-1"
			role="dialog" aria-labelledby="exampleModalLongTitle"
			aria-hidden="true">
						...
						<div class="table-responsive">
							<table class="table">
								...
								<tbody>
									...
									%>
									<tr>
										<td class="mid-align"><%=c.getCategoryName()%></td>
										<td class="mid-align">
											<a  href="updatecategory?categoryId=<%=c.getId()%>">
												<input type="submit" class="btn btn-success" value="Update"></a>	
											<a href="deletecategory?categoryId=<%=c.getId()%>">
							...
							<table class="table">
								...
								<tbody>
									...
									<tr class="text-center">
										...
										<td class="mid-align"><%=o.getStatus()%></td>
											...
											<form action="updatedeliverydate">
												...
												<div class="form-group mx-sm-3 mb-2">
													<select name="deliveryStatus" class="form-control">
														...
														<option value="OrderReady">OrderReady</option>

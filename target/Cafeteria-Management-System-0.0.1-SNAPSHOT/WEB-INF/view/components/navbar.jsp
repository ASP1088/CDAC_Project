<%@ page import ="com.cafedosti.model.*"%>
<%@ page import ="com.cafedosti.dao.*"%>
<%@ page import ="com.cafedosti.utility.*"%>
...
<div class="container-fluid">
 <a class="navbar-brand" href="/"><h3 class="text-color"><i>Cafe Dosti</i></h3></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    %>
                 ...
                 <li class="nav-item active">
                    <a class="nav-link" href="addcategory"><b class="text-color">Add Category</b> <span class="sr-only">(current)</span></a>
                 </li>
          ...
          <ul class="navbar-nav ml-auto">
              ...
              %>
                     <li class="nav-item active" data-toggle="modal" data-target="#showmycartmodal">
                        <div class="nav-link text-color"><img src="resources/images/cart.png" style="width:23px;" alt="img">
                        	<b class="text-color">Cart</b>
                        </div>
                     </li> 
    ...
    %>
      ...
      <li class="nav-item active text-color">
        <a class="nav-link" href="register"><button type="button" class="btn btn-secondary">Register</button></a>
      </li>  
      
      <li class="nav-item text-color active">
        <a class="nav-link" href="login"><button type="button" class="btn btn-success">Login</button></a>
      </li> 
...
<!-- <a class="FromTop navbar custom-bg" href="/"><img src="resources/images/mainlogo.png" width="100" height="100" class="d-inline-block align-top" alt=""></a>
 -->
<!-- show profile modal -->
...
<table class="table">
  ...
  <tbody>
   ...
   %>
    ...
    <%
    totalAmount+=(f.getPrice()*c.getQuantity());
      }
    %>
...
<hr>
		<div class="text-center row ml-5">
			    <span class="text-black mr-5 pt-1"><b>Total amount to be pay <b><b>Rs. <%=totalAmount%> /-</b></b></b></span>
		      <div class="right-align justify-content-end"><a href="checkout"><button type="button" class="btn btn-danger">Order</button></a></div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phone.png" style="width:27px;" alt="img">+91 9999999999 / +91 8888888888<br>
                <img src="resources/images/mail.png" style="width:29px;" alt="img">cafe.dosti@gmail.com
            </b>
        </p>
        </div>
      </div>

...
import com.cafedosti.dao.OrdersDao;
...
import com.cafedosti.utility.Helper;
...
public class OrdersController {
	...
	public ModelAndView addDeliveryStatus(@RequestParam("orderId") String orderId, @RequestParam("deliveryStatus") String deliveryStatus )  {
		ModelAndView mv = new ModelAndView();
		...
		for(Orders order : orders) {
			...
			mv.addObject("status", "Order Status Updated.");
			mv.setViewName("index");
	        return mv;
	}
